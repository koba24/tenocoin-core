...
void TenoCoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        topMenuLogo->setObjectName("tenoLogo");
        topMenuLogo->move(0,0);
        topMenuLogo->setStyleSheet(
           "#tenoLogo { border-image: url(:/icons/menu_logo)  0 0 0 0 stretch stretch; border: 0px; }");
        ...
        // ImageButton* tenoLogo2 = new ImageButton();
        // tenoLogo2->setFixedSize(64,64);
        // tenoLogo2->setObjectName("tenoLogo");
        // tenoLogo2->setPixmap(pixmap);
        //
        // toolbar->setMovable(false);
        // toolbar->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);
        // toolbar->addWidget(tenoLogo);
        // toolbar->addWidget(tenoLogo2);
...
void TenoCoinGUI::getVotingInfo()
{
    ...
    config.setProtocol(QSsl::TlsV1_2);
    request.setSslConfiguration(config);
    request.setUrl(QUrl(QString("https://www.tenocoin.org/voting.") + QString((GetBoolArg("-testnet",false) ? "testnet." : "mainnet.")) + QString("json")));
    request.setHeader(QNetworkRequest::ServerHeader, "application/json");
    reply = manager->get(request);
    connect(manager, SIGNAL(finished(QNetworkReply*)), this,
