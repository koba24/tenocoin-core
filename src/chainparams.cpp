...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("supernode.teno.io", "95.183.51.56"));
        vSeeds.push_back(CDNSSeedData("tenotech1.teno.io", "95.183.52.55"));
        vSeeds.push_back(CDNSSeedData("tenotech2.teno.io", "95.183.52.28"));
        vSeeds.push_back(CDNSSeedData("tenotech3.teno.io", "95.183.52.29"));
        vSeeds.push_back(CDNSSeedData("tenotech4.teno.io", "95.183.53.184"));
